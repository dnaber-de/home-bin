...
then
        ...
        rsync -a --progress /root/  "$BACKUP_PATH/root/"
else
...
then
        ...
        rsync -a --progress /var/mysql/ "$BACKUP_PATH/var/mysql/"
else
...
then
        ...
        rsync -a --progress /etc/ "$BACKUP_PATH/etc/"
else
...
then
        ...
        rsync -a --progress /opt/ "$BACKUP_PATH/opt/"
else
...
then
	...
	cd /home
        rsync -aF --progress david/  "$BACKUP_PATH/home/david/"
else
...
then
        ...
        cd /home
        rsync -aF --progress heike/ "$BACKUP_PATH/home/heike/"
else
...
then
	...
	cd /var/www
	rsync -aF --progress ./ "$BACKUP_PATH/var/www/"
else
